...
class ImageRegistration {
    ...
    func register(
        ...
        DispatchQueue.global(qos: .userInitiated).async {
            ...
            DispatchQueue.main.async {
                ...
                // Convert the composited CIImage to PlatformImage (either NSImage or UIImage, depending on the
                // platform).
    ...
    private func makeAlignedImage(
        ...
        if let translationObservation = alignmentObservation as? VNImageTranslationAlignmentObservation {
            ...
            // Creates the alignedImage by warping the floating image using the warpTransform from the homographic
            // observation.
